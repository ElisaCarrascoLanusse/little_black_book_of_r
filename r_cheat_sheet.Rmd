...
key_packages_fn <- function() {
  # List of packages
  key_packages <- c("tidyverse", "readr", "dplyr", "ggplot2", "rmarkdown", "xml2", "plotly", "shiny", "ggthemes", "janitor", "styler", "arrow", "ggsci", "rstudioapi", "ggridges")
...
Scatterplot (numerical, 3+ variables) <- ggplot(df, aes(x = variable_1, y = variable_2)) +
  ...
  geom_jitter() # Using facet_wrap cleans up graphs like these into subsets :)
